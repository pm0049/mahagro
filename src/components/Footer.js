      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-4">
            <h5 className="text-success fw-bold">About Agrobot</h5>
            <p>
              Agrobot is dedicated to helping farmers with **smart farming solutions**, using **real-time monitoring, predictive insights, and IoT-based automation**.
            </p>
          </div>
